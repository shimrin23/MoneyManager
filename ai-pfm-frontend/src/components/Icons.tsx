...
// Base Icon wrapper to ensure consistency
export const BaseIcon = ({ children, size = 20, className = '', ...props }: IconProps & { children: React.ReactNode }) => (
  <svg
...
// Specific Icons (using Lucide/Feather paths for a professional Stripe/Linear look)
